...
function processFile(input, output, file) {
	...
	// Set parameters with the scale
	//Custom model, you have to change your model_path!

	run("Cellpose Advanced (custom model)", "diameter=71 cellproba_threshold=0.0 flow_threshold=0.4 anisotropy=1.0 diam_threshold=12.0 model_path=[C:\\Users\\charles.du\\.cellpose\\models\\MDA-MB-231 X20 v2.6] model=[C:\\Users\\charles.du\\.cellpose\\models\\MDA-MB-231 X20 v2.6] nuclei_channel=0 cyto_channel=0 dimensionmode=2D stitch_threshold=-1.0 omni=false cluster=false additional_flags=");
	...
	// Set mesurements, need to activate Feret's diamater in ImageJ>Analyse>Set mesurements>Feret's diameter
